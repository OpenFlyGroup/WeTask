      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center gap-4 mb-6">
          ...
          <p className="text-sm text-muted-foreground text-center">
            Join <span className="font-medium">WeTask</span> and start organizing your work better
          </p>
        </div>
          ...
          <div className="card-body p-6">
            ...
            >
              ...
              <form.Field
                ...
                validators={{
                  onChange: ({ value }) =>
                    !value ? 'Full name is required' : value.trim().length < 2 ? 'Name must be at least 2 characters' : undefined,
                  onBlur: ({ value }) =>
                    !value ? 'Full name is required' : value.trim().length < 2 ? 'Name must be at least 2 characters' : undefined,
                }}
              >
